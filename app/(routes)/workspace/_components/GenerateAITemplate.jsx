    ...
    return (
        <div>
            <Button
                ...
                variant="outline" className="flex gap-2"> <LayoutGrid className='h-4 w-4' /> Generate AI Template</Button>
            ...
            <Dialog open={open}>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            <h2 className='mt-5'>What you want to write in this document ?</h2>
                            ...
                            <div className='mt-5 flex gap-5 justify-end'>
                                ...
                                <Button onClick={() => GenerateFromAI()} disabled={!userInput || loading}>
